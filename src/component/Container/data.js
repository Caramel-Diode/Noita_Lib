...
const containerData = new Map([
    ["common", { name: "瓶子", desc: "用来盛装液体的魔法玻璃瓶<br/>光标置于物品上时，按$0饮用" }],
    ["conical", { name: "瓶子", desc: "用来盛装液体的魔法玻璃瓶<br/>光标置于物品上时，按$0饮用" }],
    ["jar", { name: "罐子", desc: "本质上它只是个普通的玻璃罐子，但...<br/>光标置于物品上时，按$0饮用" }],
    ["bag", { name: "口袋", desc: "搬运粉末材料的方便口袋" }]
]);
