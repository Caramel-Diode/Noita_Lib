...
const Perk = (() => {
    ...
    return Object.freeze(
        class extends Base {
            static queryById = id => db_perk.queryById(id);
            static queryByName = id => db_perk.queryByName(this.name);
            ...
            contentUpdate() {
                ...
                if (perkId) this.perkData = db_perk.queryById(perkId);
                else {
                    const perkName = this.getAttribute("perk.name");
                    if (perkName) this.perkData = db_perk.queryByName(perkName);
                    else {
                        if (this.perkData === undefined) this.perkData = db_perk.$NULL;
                    }
                }
