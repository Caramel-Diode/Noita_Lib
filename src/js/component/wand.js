component.wand = class extends component.base {
    ...
    static {
        ...
        this.prototype.publicStyleSheets = {
            ...
            panel: [...superStyleSheets.panel, gss(`"WandElement_panel.css"`)]
        };
    ...
    async #loadPanelContent() {
        ...
        this.#shadowRoot.adoptedStyleSheets = [...this.publicStyleSheets.panel, gss(`:host>canvas{height:${wd.iconWidth * 5}px}`)];
        ...
        ctx.drawImage(await DB.wand.iconImage, wd.iconOrigin, 0, wd.iconWidth, 15, -wd.iconWidth, 0, wd.iconWidth, 15);
